...
class PunctuationControlsWidget(Gtk.Box):
    ...
    def __init__(self, app_instance):
        ...
        self.sensitivity_scale = Gtk.Scale(orientation=Gtk.Orientation.HORIZONTAL, adjustment=sensitivity_adjustment)
        ...
        self.endpointing_scale = Gtk.Scale(orientation=Gtk.Orientation.HORIZONTAL, adjustment=endpointing_adjustment)
    ...
    def _load_config_values(self):
        ...
        try:
            if hasattr(self.app, "config"):
                ...
                sensitivity_map = {"off": 0, "minimal": 1, "balanced": 2, "aggressive": 3}
